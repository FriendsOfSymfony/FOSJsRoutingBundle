...
class ControllerTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testIndexAction()
    {
        ...
        $this->assertEquals('{"routes":{"literal":{"tokens":[["text","\/homepage"]],"defaults":[],"requirements":[],"hosttokens":[]},"blog":{"tokens":[["variable","\/","[^\/]++","slug"],["text","\/blog-post"]],"defaults":[],"requirements":[],"hosttokens":[["text","localhost"]]}}}', $response->getContent());
    }
    ...
    public function testConfigCache()
    {
        ...
        $response = $controller->indexAction($this->getRequest('/'), 'json');
        $this->assertEquals('{"routes":{"literal":{"tokens":[["text","\/homepage"]],"defaults":[],"requirements":[],"hosttokens":[]}}}', $response->getContent());
    ...
    public function testIndexActionWithoutRoutes()
    {
        ...
        $this->assertEquals('{"routes":[]}', $response->getContent());
